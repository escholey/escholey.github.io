...
class ORCIDPublicationManager:
    ...
    def create_jekyll_publication(self, pub_info: Dict):
        ...
        frontmatter = {
            ...
            'category': pub_info.get('category', 'manuscripts'),
            'comments': False
        }
        
        # Create content
        excerpt = pub_info.get('excerpt', pub_info.get('title', ''))
        ...
        # Image is now in frontmatter, so no need for placeholder in content
